...
namespace ProcjetPOO {
	...
	private: NS_Svc::CLServiceClient^ oSvc;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Location = System::Drawing::Point(398, 12);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->Size = System::Drawing::Size(1065, 687);
			this->dataGridView1->TabIndex = 0;
			// 
			// btn_select
			// 
			this->btn_select->Location = System::Drawing::Point(12, 579);
			this->btn_select->Name = L"btn_select";
			this->btn_select->Size = System::Drawing::Size(187, 57);
			...
			// btn_insert
			// 
			this->btn_insert->Location = System::Drawing::Point(205, 579);
			this->btn_insert->Name = L"btn_insert";
			this->btn_insert->Size = System::Drawing::Size(187, 57);
			...
			// txtbox_nom
			// 
			this->txtbox_nom->Location = System::Drawing::Point(12, 84);
			this->txtbox_nom->Name = L"txtbox_nom";
			this->txtbox_nom->Size = System::Drawing::Size(379, 20);
			this->txtbox_nom->TabIndex = 3;
			// 
			// txtbox_prenom
			// 
			this->txtbox_prenom->Location = System::Drawing::Point(12, 131);
			this->txtbox_prenom->Name = L"txtbox_prenom";
			this->txtbox_prenom->Size = System::Drawing::Size(379, 20);
			this->txtbox_prenom->TabIndex = 4;
			// 
			// txtbox_adresse_liv
			// 
			this->txtbox_adresse_liv->Location = System::Drawing::Point(12, 176);
			this->txtbox_adresse_liv->Name = L"txtbox_adresse_liv";
			this->txtbox_adresse_liv->Size = System::Drawing::Size(379, 20);
			this->txtbox_adresse_liv->TabIndex = 5;
			// 
			// txtbox_ville_liv
			// 
			this->txtbox_ville_liv->Location = System::Drawing::Point(12, 223);
			this->txtbox_ville_liv->Name = L"txtbox_ville_liv";
			this->txtbox_ville_liv->Size = System::Drawing::Size(379, 20);
			this->txtbox_ville_liv->TabIndex = 6;
			// 
			// txtbox_cp_liv
			// 
			this->txtbox_cp_liv->Location = System::Drawing::Point(12, 270);
			this->txtbox_cp_liv->Name = L"txtbox_cp_liv";
			this->txtbox_cp_liv->Size = System::Drawing::Size(379, 20);
			this->txtbox_cp_liv->TabIndex = 7;
			// 
			// txtbox_adresse_fact
			// 
			this->txtbox_adresse_fact->Location = System::Drawing::Point(12, 320);
			this->txtbox_adresse_fact->Name = L"txtbox_adresse_fact";
			this->txtbox_adresse_fact->Size = System::Drawing::Size(379, 20);
			this->txtbox_adresse_fact->TabIndex = 8;
			// 
			// txtbox_ville_fact
			// 
			this->txtbox_ville_fact->Location = System::Drawing::Point(12, 371);
			this->txtbox_ville_fact->Name = L"txtbox_ville_fact";
			this->txtbox_ville_fact->Size = System::Drawing::Size(379, 20);
			this->txtbox_ville_fact->TabIndex = 9;
			// 
			// txtbox_cp_fact
			// 
			this->txtbox_cp_fact->Location = System::Drawing::Point(12, 428);
			this->txtbox_cp_fact->Name = L"txtbox_cp_fact";
			this->txtbox_cp_fact->Size = System::Drawing::Size(379, 20);
			this->txtbox_cp_fact->TabIndex = 10;
			// 
			// txtbox_date_anniv
			// 
			this->txtbox_date_anniv->Location = System::Drawing::Point(12, 485);
			this->txtbox_date_anniv->Name = L"txtbox_date_anniv";
			this->txtbox_date_anniv->Size = System::Drawing::Size(379, 20);
			this->txtbox_date_anniv->TabIndex = 11;
			// 
			// txtbox_date_premier_achat
			// 
			this->txtbox_date_premier_achat->Location = System::Drawing::Point(12, 540);
			this->txtbox_date_premier_achat->Name = L"txtbox_date_premier_achat";
			this->txtbox_date_premier_achat->Size = System::Drawing::Size(379, 20);
			this->txtbox_date_premier_achat->TabIndex = 12;
			// 
			// lbl_nom
			// 
			this->lbl_nom->AutoSize = true;
			this->lbl_nom->Location = System::Drawing::Point(9, 68);
			...
			this->lbl_prenom->Location = System::Drawing::Point(9, 115);
			...
			this->lbl_adresse_liv->Location = System::Drawing::Point(9, 160);
			...
			this->lbl_ville_liv->Location = System::Drawing::Point(9, 207);
			...
			this->lbl_cp_liv->Location = System::Drawing::Point(9, 254);
			...
			this->lbl_adresse_fact->Location = System::Drawing::Point(9, 304);
			...
			this->lbl_ville_fact->Location = System::Drawing::Point(9, 355);
			...
			this->lbl_cp_fact->Location = System::Drawing::Point(9, 412);
			...
			this->lbl_date_anniv->Location = System::Drawing::Point(9, 469);
			...
			this->lbl_date_premier_achat->Location = System::Drawing::Point(9, 524);
			...
			// btn_update
			// 
			this->btn_update->Location = System::Drawing::Point(12, 642);
			this->btn_update->Name = L"btn_update";
			this->btn_update->Size = System::Drawing::Size(187, 57);
			...
			// btn_delete
			// 
			this->btn_delete->Location = System::Drawing::Point(205, 642);
			this->btn_delete->Name = L"btn_delete";
			this->btn_delete->Size = System::Drawing::Size(187, 57);
			...
			// txtbox_idClient
			// 
			this->txtbox_idClient->Location = System::Drawing::Point(12, 35);
			this->txtbox_idClient->Name = L"txtbox_idClient";
			this->txtbox_idClient->Size = System::Drawing::Size(379, 20);
			this->txtbox_idClient->TabIndex = 2;
			// 
			// lbl_idClient
			// 
			this->lbl_idClient->AutoSize = true;
			this->lbl_idClient->Location = System::Drawing::Point(9, 19);
			...
			this->ClientSize = System::Drawing::Size(1475, 711);
...
#pragma endregion
	...
	{
		this->oSvc = gcnew NS_Svc::CLServiceClient();
	}

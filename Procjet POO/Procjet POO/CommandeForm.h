...
namespace ProcjetPOO {
	...
	private: NS_Svc::CLServiceCommande^ oSvc;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Location = System::Drawing::Point(387, 12);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->Size = System::Drawing::Size(894, 577);
			this->dataGridView1->TabIndex = 0;
			// 
			// btn_select
			// 
			this->btn_select->Location = System::Drawing::Point(12, 477);
			this->btn_select->Name = L"btn_select";
			this->btn_select->Size = System::Drawing::Size(178, 53);
			...
			// btn_insert
			// 
			this->btn_insert->Location = System::Drawing::Point(196, 477);
			this->btn_insert->Name = L"btn_insert";
			this->btn_insert->Size = System::Drawing::Size(178, 53);
			...
			// btn_update
			// 
			this->btn_update->Location = System::Drawing::Point(12, 536);
			this->btn_update->Name = L"btn_update";
			this->btn_update->Size = System::Drawing::Size(178, 53);
			...
			// btn_delete
			// 
			this->btn_delete->Location = System::Drawing::Point(196, 536);
			this->btn_delete->Name = L"btn_delete";
			this->btn_delete->Size = System::Drawing::Size(178, 53);
			...
			// txtbox_NomClient
			// 
			this->txtbox_NomClient->Location = System::Drawing::Point(12, 74);
			this->txtbox_NomClient->Name = L"txtbox_NomClient";
			this->txtbox_NomClient->Size = System::Drawing::Size(369, 20);
			this->txtbox_NomClient->TabIndex = 5;
			// 
			// txtbox_PrenomClient
			// 
			this->txtbox_PrenomClient->Location = System::Drawing::Point(12, 122);
			this->txtbox_PrenomClient->Name = L"txtbox_PrenomClient";
			this->txtbox_PrenomClient->Size = System::Drawing::Size(369, 20);
			this->txtbox_PrenomClient->TabIndex = 6;
			// 
			// txtbox_DateCommande
			// 
			this->txtbox_DateCommande->Location = System::Drawing::Point(12, 173);
			this->txtbox_DateCommande->Name = L"txtbox_DateCommande";
			this->txtbox_DateCommande->Size = System::Drawing::Size(369, 20);
			this->txtbox_DateCommande->TabIndex = 7;
			// 
			// txtbox_VilleLivraison
			// 
			this->txtbox_VilleLivraison->Location = System::Drawing::Point(12, 224);
			this->txtbox_VilleLivraison->Name = L"txtbox_VilleLivraison";
			this->txtbox_VilleLivraison->Size = System::Drawing::Size(369, 20);
			this->txtbox_VilleLivraison->TabIndex = 8;
			// 
			// txtbox_DateEmission
			// 
			this->txtbox_DateEmission->Location = System::Drawing::Point(12, 276);
			this->txtbox_DateEmission->Name = L"txtbox_DateEmission";
			this->txtbox_DateEmission->Size = System::Drawing::Size(369, 20);
			this->txtbox_DateEmission->TabIndex = 9;
			// 
			// txtbox_DateLivraison
			// 
			this->txtbox_DateLivraison->Location = System::Drawing::Point(12, 328);
			this->txtbox_DateLivraison->Name = L"txtbox_DateLivraison";
			this->txtbox_DateLivraison->Size = System::Drawing::Size(369, 20);
			this->txtbox_DateLivraison->TabIndex = 10;
			// 
			// lbl_NomClient
			// 
			this->lbl_NomClient->AutoSize = true;
			this->lbl_NomClient->Location = System::Drawing::Point(9, 59);
			...
			this->lbl_PrenomClient->Location = System::Drawing::Point(9, 106);
			...
			this->lbl_DateCommande->Location = System::Drawing::Point(9, 157);
			...
			this->lbl_VilleLivraison->Location = System::Drawing::Point(9, 208);
			...
			this->lbl_DateEmission->Location = System::Drawing::Point(12, 260);
			...
			this->lbl_DateLivraison->Location = System::Drawing::Point(9, 312);
			...
			// txtbox_IdClient
			// 
			this->txtbox_IdClient->Location = System::Drawing::Point(12, 385);
			this->txtbox_IdClient->Name = L"txtbox_IdClient";
			this->txtbox_IdClient->Size = System::Drawing::Size(369, 20);
			this->txtbox_IdClient->TabIndex = 17;
			// 
			// lbl_idClient
			// 
			this->lbl_idClient->AutoSize = true;
			this->lbl_idClient->Location = System::Drawing::Point(7, 369);
			...
			this->txtbox_idCommande->Size = System::Drawing::Size(369, 20);
			...
			this->ClientSize = System::Drawing::Size(1290, 601);
...
#pragma endregion
	...
	{
		this->oSvc = gcnew NS_Svc::CLServiceCommande();
	}
